...
OpenA/B lets you test one version of a webpage against another to determine which one produces more conversions. OpenA/B is easy to use and open-source.
